            ...
            <div class="card">
              ...
              <div class="card-header">1.Quality/Kualitas Kerja</div>
                <br>
                    <br>
                        <table border="1">
                            ...
                            <tr>
                              <td rowspan="6">   <input class="form-control" value="{{ $formulir->nilai1 }}" type="text" name="nilai1" disabled></td>
                            </tr>
                            <tr>
                              <th>100</th>
                             <th>95</th>
                ...
                <br>
                             ...
                             <input class="form-control" value="{{ $formulir->keterangan1 }}" type="text" name="keterangan1" disabled>
        ...
        <div class="col-md-15">
            <div class="card">
              <div class="card-header">2.Kuantitas Kerja(Menilai Kuantitas tugas yang diselesaikan berdasarkan standar output/target yang ditetapkan untuk tugas).</div>
                    ...
                    <br>
                        <table border="1">
                            ...
                            <th scope="col">Nilai</th>
                               ...
                               <tr>
                           <td rowspan="6">   <input class="form-control" value="{{ $formulir->nilai2 }}" type="text" name="nilai2" disabled></td>
                            </tr>
                            <tr>
                              <th>100</th>
                             <th>95</th>
                ...
                <br>
                                   <label for="">keterangan</label>
                             <input class="form-control" value="{{ $formulir->keterangan2 }}" type="text" name="keterangan2" disabled>
______________________________________________________________________________________________________________________________________________________________
            ...
            <div class="card">
              <div class="card-header">3.Kemampuan dalam menyelesaikan pekerjaan</div>
                    ...
                    <br>
                        <table border="1">
                            ...
                            <th scope="col">Nilai</th>
                               ...
                               <tr>
                               <td rowspan="6">   <input class="form-control" value="{{ $formulir->nilai3 }}" type="text" name="nilai3" disabled></td>
                            </tr>
                            <tr>
                              <th>100</th>
                             <th>95</th>
                ...
                <br>
                                   ...
                                   <label for="">keterangan</label>
                             <input class="form-control" value="{{ $formulir->keterangan3 }}" type="text" name="keterangan3" disabled>
            ...
            <div class="card">
              <div class="card-header">4.Work Atitude and Dicipline(Sikap Kerja& Kedisplinan)</div>
                    ...
                    <br>
                        <table border="1">
                            <tr>
                               ...
                               <tr>
                                <td rowspan="6">   <input class="form-control" value="{{ $formulir->nilai4 }}" type="text" name="nilai4" disabled></td>
                            </tr>
                            <tr>
                              <th>100</th>
                             <th>95</th>
                ...
                <br>
                                   ...
                                   <label for="">keterangan</label>
                             <input class="form-control" value="{{ $formulir->keterangan4 }}" type="text" name="keterangan4" disabled>
            ...
            <div class="card">
              <div class="card-header">5.Kehadiran Kerja</div>
                    ...
                    <br>
                        <table border="1">
                            <tr>
                               ...
                               <tr>
                                <td rowspan="6">   <input class="form-control" value="{{ $formulir->nilai5 }}" type="text" name="nilai5" disabled></td>
                            </tr>
                            <tr>
                              <th>100</th>
                             <th>95</th>
                ...
                <br>
                                   ...
                                   <label for="">keterangan</label>
                             <input class="form-control" value="{{ $formulir->keterangan5 }}" type="text" name="keterangan5" disabled>
        ...
        <div class="col-md-15">
            <div class="card">
              <div class="card-header">6.Kemampuan Pribadi</div>
                    ...
                    <br>
                        <table border="1">
                            <tr>
                               ...
                               <tr>
                                <td rowspan="6">   <input class="form-control" value="{{ $formulir->nilai6 }}" type="text" name="nilai6" disabled></td>
                            </tr>
                            <tr>
                              <th>100</th>
                             <th>95</th>
                ...
                <br>
                                   <label for="">keterangan</label>
                             <input class="form-control" value="{{ $formulir->keterangan6 }}" type="text" name="keterangan6" disabled>
______________________________________________________________________________________________________________________________________________________________
            </div>
            </div>
        </div>
        ...
        <div class="col-md-15">
            <div class="card">
              <div class="card-header">7.Kerja sama dengan rekan kerja departemen lain dan/atau tim kejrja dalam departemen yang sama</div>
                    ...
                    <br>
                        <table border="1">
                            <tr>
                               ...
                               <tr>
                                <td rowspan="6">   <input class="form-control" value="{{ $formulir->nilai7 }}" type="text" name="nilai7" disabled></td>
                            </tr>
                            <tr>
                              <th>100</th>
                             <th>95</th>
                ...
                <br>
                                   <label for="">keterangan</label>
                             <input class="form-control" value="{{ $formulir->keterangan7 }}" type="text" name="keterangan7" disabled>
______________________________________________________________________________________________________________________________________________________________
            ...
            <div class="card">
              <div class="card-header">8.Daya Analisa & Logika(Menilai Kemampuan Untuk Berfikir Analitis, objectif, dan logis)</div>
                    ...
                    <br>
                        <table border="1">
                            <tr>
                               ...
                               <tr>
                               <td rowspan="6">   <input class="form-control" value="{{ $formulir->nilai8 }}" type="text" name="nilai8" disabled></td>
                            </tr>
                            <tr>
                              <th>100</th>
                             <th>95</th>
                ...
                <br>
                                   ...
                                   <label for="">keterangan</label>
                             <input class="form-control" value="{{ $formulir->keterangan8 }}" type="text" name="keterangan8" disabled>
            ...
            <div class="card">
              <div class="card-header">9.Inisiatif Kerja</div>
                    ...
                    <br>
                        <table border="1">
                            ...
                            <th scope="col">Nilai</th>
                               ...
                               <tr>
                               <td rowspan="6">   <input class="form-control" value="{{ $formulir->nilai9 }}" type="text" name="nilai9" disabled></td>
                            </tr>
                            <tr>
                              <th>100</th>
                             <th>95</th>
                ...
                <br>
                                   ...
                                   <label for="">keterangan</label>
                             <input class="form-control" value="{{ $formulir->keterangan9 }}" type="text" name="keterangan9" disabled>
        ...
        <div class="col-md-15">
            <div class="card">
              <div class="card-header">10.Kemampuan membuat skala prioritas</div>
                    ...
                    <br>
                        <table border="1">
                            <tr>
                               ...
                               <tr>
                              <td rowspan="6">   <input class="form-control" value="{{ $formulir->nilai10 }}" type="text" name="nilai10" disabled></td>
                            </tr>
                            <tr>
                              <th>100</th>
                             <th>95</th>
                ...
                <br>
                                   <label for="">keterangan</label>
                             <input class="form-control" value="{{ $formulir->keterangan10 }}" type="text" name="keterangan10" disabled>
                    ...
                    <br>
                        <table border="1">
                            <tr>
                               ...
                               <tr>
                             <td rowspan="6">   <input class="form-control" value="{{ $formulir->jumlah_nilai }}" type="text" name="jumlah_nilai" disabled></td>
                            </tr>
                            <tr>
                              <th>100</th>
                             <th>95</th>
                     ...
                     <br>
                             ...
                             <input class="form-control" value="{{ $formulir->rangkuman_evaluasi }}" type="text" name="rangkuman_evaluasi" disabled>

                              <label for="">Rekomendasi : </label>
                             <input class="form-control" value="{{ $formulir->rekomendasi }}" type="text" name="rekomendasi" disabled>

                                           <a href="{{ url('/formulir') }}" class="btn btn-outline-info btn-rounded btn-block">Kembali</a>
                                        </button>
                </div>
            </div>
        </div>
